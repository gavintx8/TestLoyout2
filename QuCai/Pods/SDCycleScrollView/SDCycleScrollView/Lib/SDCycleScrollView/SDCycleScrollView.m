...
+ (instancetype)cycleScrollViewWithFrame:(CGRect)frame imageNamesGroup:(NSMutableArray *)imageNamesGroup
{
...
+ (instancetype)cycleScrollViewWithFrame:(CGRect)frame shouldInfiniteLoop:(BOOL)infiniteLoop imageNamesGroup:(NSMutableArray *)imageNamesGroup
{
    SDCycleScrollView *cycleScrollView = [[self alloc] initWithFrame:frame];
...
- (void)setImageURLStringsGroup:(NSMutableArray *)imageURLStringsGroup
{
...
- (void)setLocalizationImageNamesGroup:(NSMutableArray *)localizationImageNamesGroup
{
    _localizationImageNamesGroup = localizationImageNamesGroup;
    self.imagePathsGroup = [localizationImageNamesGroup copy];
}

- (void)setTitlesGroup:(NSMutableArray *)titlesGroup
{
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSString * imageUrl = [imagePath stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding];
