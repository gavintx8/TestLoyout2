...
- (UIButton *)leftBtn {
    if (!_leftBtn) {
        ...
        _leftBtn.layer.borderColor = [UIColor colorWithRed:141.0/255 green:142.0/255 blue:144.0/255 alpha:1].CGColor;
        _leftBtn.layer.borderWidth = 1.0f;
        _leftBtn.layer.masksToBounds = YES;
        _leftBtn.titleLabel.font = [UIFont systemFontOfSize:15.0f];
        [_leftBtn setTitleColor:[UIColor colorWithRed:141.0/255 green:142.0/255 blue:144.0/255 alpha:1] forState:UIControlStateNormal];
...
- (UIButton *)rightBtn {
    if (!_rightBtn) {
        ...
        _rightBtn.backgroundColor = [UIColor colorWithRed:141.0/255 green:142.0/255 blue:144.0/255 alpha:1];
...
- (UILabel *)titleLabel {
    if (!_titleLabel) {
        ...
        _titleLabel.textColor = [UIColor colorWithRed:141.0/255 green:142.0/255 blue:144.0/255 alpha:1];
