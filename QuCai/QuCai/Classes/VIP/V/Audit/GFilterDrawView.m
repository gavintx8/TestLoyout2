...
@interface GFilterDrawView()<UIGestureRecognizerDelegate>
{
    UILabel *endLabel;
    UIButton *endBtuuon;
}
...
@implementation GFilterDrawView
{
    filterDrawBlock _drawBlock;
}
...
- (void)buildSortView:(UIView *)view{
    UILabel *lblSort = [self createSectionLabelTitle:@"    状态"];
    ...
    UIButton *sortButton1 = [self createButtonTag2:@"所有" and:401];
    ...
    UIButton *sortButton2 = [self createButtonTag2:@"处理中" and:402];
    ...
    UIButton *sortButton3 = [self createButtonTag2:@"未通过" and:403];
    ...
    UIButton *sortButton4 = [self createButtonTag2:@"已通过" and:404];
...
- (void)nextButtonClick:(UIButton *)button{
    if (_drawBlock) {
        _drawBlock(self.bdateString,self.edateString,self.statusString,self.timeTag,self.statusTag);
        [self hide];
    }
}
